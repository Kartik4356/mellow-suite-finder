  ...
  return (
    <div className="space-y-8">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Stat label="Active rooms" value={activeRooms.toString()} />
        ...
        <Stat label="Subscription plan" value={settings.subscription_plan.toUpperCase()} />
      </div>

      <div className="rounded-lg border border-border bg-card p-6">
        <h2 className="font-serif text-2xl">Welcome, Administrator</h2>
        <p className="mt-2 text-muted-foreground">
          Use the tabs above to manage rooms, assign staff and admin roles, and adjust the house theme and subscription.
        </p>
      </div>
    </div>
  );
